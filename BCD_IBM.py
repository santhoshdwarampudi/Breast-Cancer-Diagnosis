...
def about():
    ...
    img31.pack()
    valid_var = "I AM A STUDENT OF NATIONAL INSTITUTE OF TECHNOLOGY, SRINAGAR."
    valid_var1 = "I am developing this project to help persons to check \nwhether they have BREAST CANCER or not.\nUser provide some values to the model and \nmodel predict the diagnosis.\nThis model have 95% + accuracy."
    valid_var2 = " SANTHOSH REDDY"
